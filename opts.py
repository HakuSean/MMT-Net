...
def parse_opts():
    ...
    # -- Input and Output -------------------------
    # ---------------------------------------------
    parser.add_argument('dataset', type=str, default='ct40k', choices=['ct_sample', 'cq500', 'ct40k'],
                        help='Used dataset')
    ...
    parser.add_argument('--spatial_crop', '--sc', type=str, default='center', choices=['random', 'corner', 'center'],
    ...
    parser.add_argument('--fusion_type', type=str, default='avg', choices=['avg', 'max', 'topk'],
                        help='Fusion method for different frames/clips.')
