###############################################################################
# PartialConv layers and classes
...
__all__ = ['SEPNet', 'se_presnext50_32x4d']
...
class SEPResNeXtBottleneck(nn.Module):
    """
    ...
    def __init__(self, inplanes, planes, groups, reduction, stride=1,
        ...
        super(SEPResNeXtBottleneck, self).__init__()
        ...
        self.conv3 = PartialConv2d(width, planes * 4, kernel_size=1, bias=False)
        self.bn3 = nn.BatchNorm2d(planes * 4)
        self.relu = nn.ReLU(inplace=True)
        self.se_module = SEPModule(planes * 4, reduction=reduction)
    ...
    def __init__(self, block, layers, groups, reduction, dropout_p=0.2,
        ...
        if input_3x3:
            layer0_modules = [
                ...
                ('conv3', PartialConv2d(64, inplanes, 3, stride=1, padding=1,
                                    bias=False)),
...
def se_presnext50_32x4d(num_classes=1000, pretrained='imagenet'):
    model = SEPNet(SEPResNeXtBottleneck, [3, 4, 6, 3], groups=32, reduction=16,
